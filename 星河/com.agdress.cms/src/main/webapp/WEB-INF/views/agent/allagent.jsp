...
//                    cell.innerHTML = cicada.CONSTS.TASK_TYPE.getName(i+1);
        ...
        $("#okAdd").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: agdress.CONSTS.URL_BASE_API+"ss_agent/addAgent",
                data: {
        ...
        $("#dataTable tbody").on("click", ".toupdate", function () {
            ...
            var linkUrl= agdress.CONSTS.URL_BASE_AGENT_LINKURL+data.agentId;
            $(".linkUrl").val(linkUrl);
            //使用canvas生成
        ...
        $("#okUpdate").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: agdress.CONSTS.URL_BASE_API+"ss_agent/updateAgent",
                data: {
                    "userId"   : $(".userId").val(),
                    "agentId"   : $(".agentId").val(),
