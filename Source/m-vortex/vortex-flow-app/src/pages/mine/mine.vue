...
<template>
  <div class="mine">
    ...
    <div class="user-data">
      ...
      <div @click="goMinePublish" class="data-title">我的发布</div>
      ...
      <div @click="goMinePublish" v-if="userInfoData !== null && userInfoData.publish_count != null" class="data-number" style="color: #ff3c3c">{{userInfoData.publish_count}}</div>
      <div @click="goMinePublish" v-else class="data-number" style="color: #ff3c3c">0</div>
    </div>
    <div class="mine-op">
      <f7-list>
