...
module.exports = function (req, res, next) {
    Q.fcall(function () {
        ...
        return Q.ninvoke(mysql, 'query', {
            ...
            "WHERE from_type IN (2,3,5,6) AND DATE_FORMAT( create_date, '%Y%m' ) = DATE_FORMAT( CURDATE( ) , '%Y%m' ) GROUP BY user_id ) AS t " +
            ...
            res.pkg.data = result[0].map(function (p1, p2, p3) {
                //p1.head_url = config.prefix_img_url_header + (p1.head_url || '');
