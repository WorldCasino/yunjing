...
import com.kk.commons.utils.IapVerifyUtil;
import com.kk.commons.utils.RedisLockUtil;
...
public class RenXinPayController extends BaseController {
    ...
    public ResponseEntity requestManualPay(@CurrentUser UserEntity user, @RequestBody JSONObject params){
        ...
        String requestUrl = renXinPayService.requestPay(user,params);
...
//                    String purchase_date = returnJson.getString("purchase_date");
                    ...
                    for (int i=0;i<productArr.size();i++) {
                        ...
                        //充值
                        RechargeEntity entity = renXinPayService.rechargeByIap(user, prod.getString("product_id"), receipt);
