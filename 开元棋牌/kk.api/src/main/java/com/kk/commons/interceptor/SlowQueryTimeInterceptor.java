package com.kk.commons.interceptor;
...
public class SlowQueryTimeInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (elapsed > slowMilliSecond) {
            ...
            //超时sqllogger记录
            SpringContextUtil.getDBLoggerDao().saveDetail( removeBreakingWhitespace(boundSql.getSql()),"4","sql function long time" ,String.valueOf(elapsed),   "","");
         }
