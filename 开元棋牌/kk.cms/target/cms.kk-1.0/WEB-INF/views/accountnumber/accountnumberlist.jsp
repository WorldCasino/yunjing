...
<script>
    $(function () {
        ...
        var tables = $("#dataTable").dataTable(
            //URL
            kk.getDatatableSettings('user/system/xtdataGrid',
                //查询条件
                'queryForm',
                //对应上面thead里面的序列
                [
...
//                    cell.innerHTML = cicada.CONSTS.TASK_TYPE.getName(i+1);
        ...
        $("#okAdd").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: kk.CONSTS.URL_BASE_API+"user/system/addUserForXt",
                data: {
        ...
        $("#okUpdate").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: kk.CONSTS.URL_BASE_API+"user/system/updateUserForXt",
                data: {
                        "userId":$(".userId").val(),
        ...
        $("#sureChange").on("click", function () {
            $.ajax({
                type: "POST",
                url: kk.CONSTS.URL_BASE_API+"user/system/updateUserForStatus",
                data: {
                    "userId":$(".userId").val(),
        ...
        if(true) {
            $.ajax({
                type: "POST",
                url: kk.CONSTS.URL_BASE_API+"role/system/getRoleList",
                data: {},
                async: false,
                success: function (data) {
