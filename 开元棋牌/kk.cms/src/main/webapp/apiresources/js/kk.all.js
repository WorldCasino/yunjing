(function(window,document){
    ...
    kk.CONSTS ={
         ...
         * 本地
         */
        URL_BASE_CMS:"http://localhost:8080/cms/",//当前项目接口URL
        URL_BASE_API:"http://localhost:8099/kk/",//api项目接口URL
    ...
    kk.ENUMS = {
        ...
        TASK_TYPE:{
            ...
            getName:function (code) {
                return kk.getEnumName(this.list,code);
            }
        },
        ...
        TRADE_TYPE:{
            ...
            getFlag:function (code) {
                var items = kk.getArrayItem(this.list,"id",code);
    ...
    kk.DATE_RANGE_PICKER_OPTIONS = {
        ...
        "locale": {
            ...
            "weekLabel": "W",
            "daysOfWeek": kk.CONSTS.DAYS_OF_WEEK,
            "monthNames": kk.CONSTS.MONTH_NAMES,
            "firstDay": 1,
     ...
     * @returns {string}
     */
    kk.timeStamp2String = function(time){
     ...
     * @returns {number}
     */
    kk.timeStamp2Date = function (time) {
        var strDate = kk.timeStamp2String(time);
     ...
     * @returns {boolean}
     */
    kk.isNullOrEmpty = function (value) {
        return (value || "") === "";
    };
     ...
     * @return Array 过滤后数组
     */
    kk.removeArrayItem = function (arr, objPropery, objValue) {
     ...
     * @return Array 过滤后的数组
     */
    kk.getArrayItem = function (arr, objPropery, objValue) {
        return $.grep(arr, function (cur, i) {
            return cur[objPropery] == objValue;
        });
    };
     ...
     * @returns {*}
     */
    kk.getEnumName = function (enumList,code) {
        var items = kk.getArrayItem(enumList,"id",code);
     ...
     */
    kk.initFileInput = function (ctrlName, maxFileCount, uploadUrl) {
     ...
     * @returns {{}}
     */
    kk.serializeJson = function (formId) {
        var serializeObj = {};
     ...
     */
    kk.post = function (url,formData,fnSuccessCallback,fnErrorCallback,contentType) {
        $.ajax({
            url: kk.CONSTS.URL_BASE_API + url,
            type: 'post',
            data: formData,
            processData:false,
     ...
     * @param contentType 指定ContentType
     */
    kk.get = function (url,formData,fnSuccessCallback,fnErrorCallback,contentType) {
        $.ajax({
            url: kk.CONSTS.URL_BASE_API + url,
            type: 'get',
            data: formData,
     ...
     * @returns {null}
     */
    kk.getQueryString = function (paramName) {
     ...
     * @returns {string}
     */
    kk.getMessageListHtml = function(errmsg){
        var html = "";
        if($.isArray(errmsg)) {
            html += "<ul>";
     ...
     */
    kk.getDatatableSettings = function (url,queryForm,columnList,rowButtonDefs,fnDrawCallback) {
        var settings = {
            sScrollY:'58vh',
