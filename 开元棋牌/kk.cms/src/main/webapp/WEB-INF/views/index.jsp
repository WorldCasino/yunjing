...
<%@page   import="com.kk.commons.utils.SystemConfig"  %>
<!DOCTYPE html>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo" >
            ...
            <span class="logo-lg"><b>开元</b>棋牌</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 kk Dev Group.</strong> All rights reserved.
    </footer>
	<!--隐藏的退出弹窗点击退出显示-->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        <%--kk.CONSTS.URL_BASE_IMG = "<%=SystemConfig.getInstance().getURL_BASE_IMG()%>";--%>
        <%--kk.CONSTS.URL_BASE_API = "<%=SystemConfig.getInstance().getURL_BASE_API()%>";--%>
        <%--kk.CONSTS.URL_BASE_CMS = "<%=SystemConfig.getInstance().getURL_BASE_CMS()%>";--%>
        ...
        function menu() {
            $.ajax({
                type : "POST",  //提交方式
                url : kk.CONSTS.URL_BASE_API+"modules/system/tree",
        ...
        menu();
         ...
         $("#loginOut").click(function(){
             $.ajax({
                 type :"post",
                 url :kk.CONSTS.URL_BASE_CMS+"logout",
                 success : function(data){
                	 if (data) {
                		  window.location.href = kk.CONSTS.URL_BASE_CMS+'login';
					}
                 }
             });
         });
        ...
        $("#sendMessage").on("click", function () {
            kk.post('captcha/sms',JSON.stringify({mobile : $(".phone").val()}), function (result) {
                layer.msg('发送成功！');
             },function (err) {
        ...
        $("#okUpdate").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: kk.CONSTS.URL_BASE_API+"user/system/updatePassword",
                data: {
    ...
    function messageList() {
        ...
        $.ajax({
            type : "POST",  //提交方式
            url : kk.CONSTS.URL_BASE_API+"message/system/listMessage",
            ...
            success : function(myjson) {
                ...
                for(var i=0;i<listMessage.length;i++){
                    ...
                    if(listMessage[i].messageType.code == 50){
                        str="addTabs({id:'"+listMessage[i].messageContentId+"',title: '出金审核列表"+listMessage[i].messageContentId+"',close: true,url: 'ss_audit/withdrawal?tradeNo="+listMessage[i].tradeNo+"&messageContentId="+listMessage[i].messageContentId+"'})";
                    }else{
