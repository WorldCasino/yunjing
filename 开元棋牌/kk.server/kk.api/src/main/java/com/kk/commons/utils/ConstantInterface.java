...
public interface ConstantInterface {
     ...
     * 短信接口请求KEY
     */
    String KEY_SMS_REQUEST = "KK:SMS_REQUEST:";

    /**
     * 短信验证码KEY
     */
    String KEY_SMS_CAPTCHA = "KK:SMS_CAPTCHA:";

    /**
     * 图形验证码KEY
     */
    String KEY_IMG_CAPTCHA = "KK:IMG_CAPTCHA:";

    /**
     * 充值结果通知存储KEY
     */
    String KEY_RECHARGE_NOTIFY = "KK:RECHARGE_NOTIFY:";
    String KEY_RECHARGE_LOCK = "KK:RECHARGE_LOCK:";
     ...
     * 发送短信
     */
    String KEY_MESSAGE = "KK:KEY_MESSAGE:";
