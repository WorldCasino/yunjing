...
public class RedisTokenManager implements ITokenManager{
    ...
    public TokenEntity createToken(long userId){
        try {
            ...
            String token = jwtUtil.createJWT(userId,userId,ttlMillis);
     ...
     * @return
     */
    public TokenEntity createToken(long userId,long phone){
        try {
            long ttlMillis = ConstantInterface.TOKEN_EXPIRES_HOUR * 60 * 60 * 100;
            String token = jwtUtil.createJWT(userId,phone,ttlMillis);
