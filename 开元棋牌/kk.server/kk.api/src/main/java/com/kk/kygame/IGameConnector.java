...
//    GameRsp<Object> searchBalance( String account ) throws Exception;
    ...
    GameRsp<Object> gamesAllBalance( String account ) throws Exception;

    GameRsp<Object> gamesAllBalanceVisitor( String account ) throws Exception;
...
//    GameRsp<Object> isLogin( String account ) throws Exception;
    ...
    GameRsp<Object> loginByVisitor(String account,String money,String ip,String  lineCode ,int KindID) throws Exception;
