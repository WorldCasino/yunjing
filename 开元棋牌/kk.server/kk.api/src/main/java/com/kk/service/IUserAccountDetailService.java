...
public interface IUserAccountDetailService extends IService<UserAccountDetailEntity> {
     ...
     * @throws ApiException
     */
    boolean applyWithdraw(UserEntity user,double amount,long cardId, String captcha) throws Exception;


    UserAccountDetaillistVo selectByTradeId(Long trade_id);

    void UpdateAccountDetail(String tradeId, String examine, String playMoney, String updateBy, String remarks) throws Exception;
