    ...
    <div class="row-fluid">
        <form id="queryForm" class="form-horizontal" action="" method="post">
            ...
            <div class="form-group">
                <label for="userId" class="col-sm-2 control-label">用户昵称</label>
                <div class="col-sm-2" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2" >
                    <select class="beuserList form-control" name="beUserNumber" id="beUserNumber">
...
<script>
    $(function () {
        ...
        $("input[name='date2']").daterangepicker(kk.DATE_RANGE_PICKER_OPTIONS,
            function(start, end, label) {
        ...
        var tables = $("#dataTable").dataTable(
            //URL
            kk.getDatatableSettings('user/system/dataGrid',
                //查询条件
                'queryForm',
                //对应上面thead里面的序列
                [
...
//        }
        ...
        if(true) {
            $.ajax({
                type: "POST",
                url: kk.CONSTS.URL_BASE_API+"user/system/getBeUserList",
                data: {},
                async: false,
                success: function (data) {
                    var beuserList=data.data;
                    for(var i =0 ;i <beuserList.length ; i++){
                        $(".beuserList").append("<option value="+beuserList[i].loginName+">"+beuserList[i].loginName+"</option>");
                    }
                }
            });
        }
