...
<div class="content">
    <div class="row-fluid">
        <form id="queryForm" class="form-horizontal" action="" method="post">
            <input type="hidden" name="tradeTypeIds" value="2,3,5,6">
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select id ="fromType" name="fromType" multiple="multiple" class="form-control">
                        <option value="2">竞猜收入</option>
                        <option value="3">竞猜下注</option>
                        <option value="5">发布竞猜盈利</option>
                        <option value="6">发布竞猜赔付</option>
                    </select>
                </div>
            </div>
        </form>
    ...
    $(function () {
        ...
        var dataColumns = [
            ...
            },
            {
                "data": 'pubUser',
                "render": function (data,type,rowData,callback) {
                    return cicada.isNullOrEmpty(data) ? rowData.pubUserPhone :
                        (cicada.isNullOrEmpty(rowData.pubUserPhone)?data:data+"<br/>"+rowData.pubUserPhone);
                }
            },
            {
                "data": 'operater',
