(function(window,document){
     ...
     * @param searchFormData 查询条件
     * @param columnList 对应上面thead里面的序列
     * @param rowButtonDefs 行操作按钮定义
     * @param fnDrawCallback Table绘制后的回调函数
     */
    cicada.getDatatableSettings = function (url,searchFormData,columnList,rowButtonDefs,fnDrawCallback) {
        var settings = {
            sScrollY:'58vh',
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    searchFormData.forEach(function (e) {
