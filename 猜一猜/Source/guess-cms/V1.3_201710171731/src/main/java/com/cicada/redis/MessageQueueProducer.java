...
public class MessageQueueProducer {
     ...
     * @param chatMessage 聊天室消息
     */
    public void sendRewardMessage(Serializable chatMessage){
        redisTemplate.convertAndSend(ConstantInterface.REDIS_QUEUE_PUSH_MESSAGE,chatMessage);
    }

    /**
     * 往OPERATEMESSAGE队列插入 操作详情
     * @param operateVo 操作详情
     */
    public void sendOperateMessage(Serializable operateVo){
        redisTemplate.convertAndSend(ConstantInterface.REDIS_QUEUE_OPERATE,operateVo);
    }
}
