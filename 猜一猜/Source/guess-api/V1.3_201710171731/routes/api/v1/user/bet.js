            ...
            if(judge === 0){//不能用金豆
                ...
                if(coin_first==0){
                    ...
                    if((result[0][0][0].coin_balance - result[0][0][0].coin_locked) >= (quantity * result[1][0][0].price)){
                        ...
                        pd.checkState(false, '金币不足，购买金币后再下注',1001);

                    }
                }
                //优先金豆下注
                else if(coin_first==1){
                    pd.checkState(false, '此竞猜不能用金豆下注',1001);
                }
            }
            if(judge === 1){//可以用金豆
                //优先金币下注
                ...
                //优先金豆下注
                    ...
                    console.log(result[0][0][1].coin_balance+":"+result[0][0][1].coin_locked)
                    //金豆足够下注
                    if(result[0][0][1].coin_balance >= (quantity * result[1][0][0].price)){
