...
module.exports.get = function () {
    // 数据页面
    const uri = 'https://www.bwin1828.com/zh-cn/sport/football/coupons/100/6323610;6270510;6316510;6317710;6320610/0/62607/0/MPE/0/0/0/40/1';
    // 页面能获取几天数据
    const countOfDays = 5;
    return Q.fcall(function () {
        ...
        Q.ninvoke(mysql, 'query', {
            sql :  "delete from t_play_odds where play_id=1 and match_id<>0 "
        })
