...
io.sockets.on('connection', function (socket) {
    ...
    /**
     * 观察玩家可领取奖励的任务数量 data: {userId:123, cnt:0}
     */
    socket.on('observeActive',function (data) {
        console.log('observeActive ' +socket.id + ' ' +data);
        kernel.onUpdateObserveActive(socket,JSON.parse(data));
    });
});
