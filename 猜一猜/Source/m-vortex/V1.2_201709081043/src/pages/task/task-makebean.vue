...
<template>
  <f7-page navbar-fixed>
    ...
    <f7-navbar sliding class="nav-custom">
        ...
        <f7-nav-center>任务</f7-nav-center>
    </f7-navbar>
    ...
    <div class="task">
      ...
      <section class="task-head">
        <div class="task-bean-item">{{parseInt(taskData.coin_balance)}}</div>
        <div class="task-type">
        ...
        <div class="task-active-can">
          ...
          <div class="task-flex-item">
            ...
            <div v-for='(item, index) in taskBox' v-if="taskData.today_liveness >= 30 && taskData.today_liveness < 90" :key="Math.random()">
              <img src="../../../static/task/ashen-light-box.gif" v-if="item.received == 0 && item.active_id == 181" @click="getReward(item.active_id, item.coin_type, item.reward_coins, item.reward_liveness)"/>
            ...
            <div v-for='(item, index) in taskBox' v-if="taskData.today_liveness >= 90 && taskData.today_liveness < 150" :key="Math.random()">
              <img src="../../../static/task/ashen-light-box.gif" v-if="item.received == 0 && item.active_id == 181" @click="getReward(item.active_id, item.coin_type, item.reward_coins, item.reward_liveness)"/>
              <img src="../../../static/task/gray-box.png" v-if="item.received == 1 && item.active_id == 181"/>
              <img src="../../../static/task/purple-light-box.gif" v-if="item.received == 0 && item.active_id == 182" @click="getReward(item.active_id, item.coin_type, item.reward_coins, item.reward_liveness)"/>
            ...
            <div v-for='(item, index) in taskBox' v-if="taskData.today_liveness >= 150" :key="Math.random()">
              ...
              <img src="../../../static/task/purple-light-box.gif" v-if="item.received == 0 && item.active_id == 182" @click="getReward(item.active_id, item.coin_type, item.reward_coins, item.reward_liveness)"/>
              <img src="../../../static/task/gray2-box.png" v-if="item.received == 1 && item.active_id == 182"/>
              <img src="../../../static/task/gold-light-box.gif" v-if="item.received == 0 && item.active_id == 183" @click="getReward(item.active_id, item.coin_type, item.reward_coins, item.reward_liveness)"/>
              <img src="../../../static/task/gray2-white-box.png" v-if="item.received == 1 && item.active_id == 183"/>
            </div>
          </div>
