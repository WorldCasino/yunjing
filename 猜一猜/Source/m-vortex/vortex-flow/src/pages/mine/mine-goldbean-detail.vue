...
<template>
  <f7-page navbar-fixed>
    <f7-navbar sliding class="nav-custom">
      ...
      <f7-nav-center >金豆明细</f7-nav-center>
    </f7-navbar>
    <div class="mine-gold" v-if="goldData !== null">
      <div v-for="waters in goldData.water">
        ...
        <div v-for="water in waters" :key="new Date().getTime()">
          <GoldItem :coins="water.coins" :from_type="water.from_type" :create_date="water.create_date"></GoldItem>
        </div>
      </div>
    </div>
    <div v-else>
