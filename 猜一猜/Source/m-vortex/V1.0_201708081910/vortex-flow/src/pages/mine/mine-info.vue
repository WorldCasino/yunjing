    ...
    <div class="mine-info">
      ...
      <div class="header">
        <f7-list class="header-list-content">
          ...
          >
            <div class="header-info">
              ...
              <div v-else class="head-img" ref="headDom" :style="{background: 'url(./../../assets/default_header.png) no-repeat center / cover'}"></div>
              <picture-input
        ...
        <f7-list class="info-list-content">
          <f7-list-item link="/mine-nickname/" title="昵称"><span class="color6">{{userInfoData.nickname}}</span></f7-list-item>
          ...
          <f7-list-item link="/mine-sex/" title="性别"><span class="color6">{{sexDesc}}</span></f7-list-item>
