<template>
  <f7-page navbar-fixed>
    ...
    <PlayerSub v-for="player in playersData" key='player'
               :avatar="player.head_url" :username="player.nickname" :is-male="player.gender" :refresh-time="player.create_date" :total-buy-count="player.quantity"></PlayerSub>
  </f7-page>
</template>
