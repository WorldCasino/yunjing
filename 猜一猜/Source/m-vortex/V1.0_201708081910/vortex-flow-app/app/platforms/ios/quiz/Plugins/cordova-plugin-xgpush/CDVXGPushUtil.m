...
//  }];
    ...
    [CDVRegisterNotification registerAPNS];
}
...
//    [XGPush setAccount:alias];
      [XGPush registerDevice:self.deviceToken account:alias successCallback:success errorCallback:error];
  } else {
...
- (NSString*) getDeviceTokenString {
    if (self.deviceToken == NULL) {
        ...
        return [XGPush getDeviceToken:self.deviceToken];
    }
}
