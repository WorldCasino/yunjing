  ...
  <div style="background: white">
    <div class="box-header-info">
      <div class="item-avatar" v-on:click="navToQuizPlayer()">
        <img v-if="avatar" width="32" height="32" style="border-radius: 100%" v-bind:src="avatar"/>
        <img v-else src="../../assets/default_header.png" width="32" height="32" style="border-radius: 100%"/>
      </div>
