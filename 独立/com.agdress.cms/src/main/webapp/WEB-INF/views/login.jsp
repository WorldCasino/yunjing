...
<script>
    $(document).ready(function() {
        ...
        $('#form_login').bootstrapValidator({
            ...
            //这里提交表单
            $.post(agdress.CONSTS.URL_BASE_API+'login', {
                    loginName: $("#userName").val(),
                    passWord: $("#password").val(),
                    validCode: $("#validCode").val(),
            }, function (result) {
            	if (result.msg == "") {
            		window.location.href=agdress.CONSTS.URL_BASE_API+'index';
				}else{
        ...
        $("#img_verify").on("click", function () {
            $(this).attr("src", agdress.CONSTS.URL_BASE_API+"captcha-image?t=" + Math.random());
        });
