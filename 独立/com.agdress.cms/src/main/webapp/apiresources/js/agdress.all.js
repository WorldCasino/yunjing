(function(window,document){
    ...
    agdress.CONSTS ={
         ...
         * 接口URL
         */
        URL_BASE_API:"http://localhost:8080/cms/",
    ...
    agdress.ENUMS = {
        ...
        TASK_TYPE:{
            ...
            getName:function (code) {
                return agdress.getEnumName(this.list,code);
            }
        },
        ...
        TRADE_TYPE:{
            ...
            getFlag:function (code) {
                var items = agdress.getArrayItem(this.list,"id",code);
     ...
     */
    agdress.DATE_RANGE_PICKER_OPTIONS = {
        "autoApply": true,
        ...
        "locale": {
            ...
            "weekLabel": "W",
            "daysOfWeek": agdress.CONSTS.DAYS_OF_WEEK,
            "monthNames": agdress.CONSTS.MONTH_NAMES,
            "firstDay": 1,
     ...
     * @returns {string}
     */
    agdress.timeStamp2String = function(time){
     ...
     * @returns {number}
     */
    agdress.timeStamp2Date = function (time) {
        var strDate = agdress.timeStamp2String(time);
     ...
     * @returns {boolean}
     */
    agdress.isNullOrEmpty = function (value) {
        return (value || "") === "";
    };
     ...
     * @return Array 过滤后数组
     */
    agdress.removeArrayItem = function (arr, objPropery, objValue) {
     ...
     * @return Array 过滤后的数组
     */
    agdress.getArrayItem = function (arr, objPropery, objValue) {
        return $.grep(arr, function (cur, i) {
            return cur[objPropery] == objValue;
        });
    };
     ...
     * @returns {*}
     */
    agdress.getEnumName = function (enumList,code) {
        var items = agdress.getArrayItem(enumList,"id",code);
     ...
     */
    agdress.initFileInput = function (ctrlName, maxFileCount, uploadUrl) {
     ...
     * @returns {{}}
     */
    agdress.serializeJson = function (formId) {
        var serializeObj = {};
     ...
     */
    agdress.post = function (url,formData,fnSuccessCallback,fnErrorCallback,contentType) {
        $.ajax({
            url: agdress.CONSTS.URL_BASE_API + url,
            type: 'post',
            data: formData,
            processData:false,
     ...
     * @param contentType 指定ContentType
     */
    agdress.get = function (url,formData,fnSuccessCallback,fnErrorCallback,contentType) {
        $.ajax({
            url: agdress.CONSTS.URL_BASE_API + url,
            type: 'get',
            data: formData,
     ...
     * @returns {null}
     */
    agdress.getQueryString = function (paramName) {
     ...
     * @returns {string}
     */
    agdress.getMessageListHtml = function(errmsg){
        var html = "";
        if($.isArray(errmsg)) {
            html += "<ul>";
     ...
     */
    agdress.getDatatableSettings = function (url,queryForm,columnList,rowButtonDefs,fnDrawCallback) {
        var settings = {
            sScrollY:'58vh',
    ...
    window.agdress = agdress;

}(window,document));


var agdress = window.agdress;
